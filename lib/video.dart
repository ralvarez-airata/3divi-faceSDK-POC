...
class VideoProcessing extends StatefulWidget {
  ...
  final List<ActiveLivenessCheckType> ckecks;
  final bool auto;

  VideoProcessing(this.cameras, this._facerecService, this._recognizer, this.nextRoute, this.callback, this.ckecks, this.auto);
...
class _VideoProcessingState extends State<VideoProcessing> {
  ...
  void initState() {
    ...
    List<ActiveLivenessCheckType> checks = widget.ckecks;
    print("===================== INICIO ============================");
      ...
      _videoWorker = widget._facerecService.createVideoWorker(
          VideoWorkerParams()
              ...
              .video_worker_config(
                  ...
                  // Config("video_worker_fdatracker_telpo_depth_liveness.xml")
                    .overrideParameter("enable_liveness_2d", 1)
          ...
          VideoWorkerParams()
              ...
              .video_worker_config(
                  ...
                  // Config("video_worker_fdatracker_telpo_depth_liveness.xml")
                    ...
                    .overrideParameter("base_angle", baseAngle.toDouble())
                    .overrideParameter("active_liveness.apply_horizontal_flip", apply_horizontal_flip)
                    .overrideParameter("max_detection_period", 2)
                  )
              .streams_count(1)
              .processing_threads_count(0)
              .matching_threads_count(0)
